...
create table Item_User(
  ...
  `itemId` INT NOT NULL,
  `userId` INT NOT NULL,
  `active` varchar(20) NOT NULL DEFAULT 'available',
  PRIMARY KEY (`id`),
...
(1000, 'admin', 'admin','16129785228', 'admin@email.com', 'admin','admin','1087 Maneland Ave W', 
'St. Paul', 'MN', 'USA', '2009-08-13', 'I am the boss here.', '1985-06-14', 'male', 999999),
(1001, 'Stephen', 'King','18241599931', 'stephen.king@email.com','123456','chef','8468 North Hilldale Drive', 
'Fayetteville', 'NC', 'USA', '2011-07-10', 'I am the Chef here.', '1985-05-12', 'male', 7000),
(1002, 'David', 'Kerry','15422362865', 'david.kerry@email.com','123456','chef','1356 Century Ave E', 
'St, Paul', 'MN', 'USA', '2009-08-13', 'I am the Chef here.', '1989-04-22', 'female', 6500),
(1003, 'John', 'Kelvin','19622389383', 'john.kelvin@email.com','123456','chef','577 Glenwood Dr.', 
'Palos Verdes Peninsula', 'CA', 'USA', '2009-08-13', 'I am the Chef here.', '1985-05-12', 'male', 4000),
(1004, 'Melanie', 'James','16298350615', 'melanie.james@email.com','123456','chef','573 Blackburn Street', 
'Osseo', 'MN', 'USA', '2009-08-13', 'I am the Chef here.', '1985-05-12', 'male', 4000),
(1005, 'Elizabeth', 'Young','19696180709', 'Elizabeth.Young@email.com','123456','employee', '936 South Goldfield Court',
'Schenectady', 'NY', 'USA','2010-08-13', 'I am employee here.', '1989-08-16', 'female', 3500),
(1006, 'Anna', 'Wright','19961614174', 'Anna.Wright@email.com','123456','employee', '488 S. Golf Rd.',
'Westerville', 'AK', 'USA','2015-08-13', 'I am employee here.', '1989-07-16', 'female', 3500),
(1007, 'Faith', 'Alsop','15894979029', 'Faith.Alsop@email.com','123456','employee', '7244 Lees Creek Dr.',
'Anchorage', 'OH', 'USA','2015-08-13', 'I am employee here.', '1989-07-16', 'female', 3500),
(1008, 'Bella', 'Gibson','18230750098', 'Bella.Gibson@email.com','123456','employee', '124 Proctor St.',
'Revere', 'MA', 'USA','2015-08-13', 'I am employee here.', '1989-07-16', 'female', 3500),
(1009, 'Matt', 'Peters','12173802481', 'Matt.Peters@email.com','123456','employee', '554 Olive St.',
'Southaven', 'MS', 'USA','2015-08-13', 'I am employee here.', '1989-07-16', 'female', 3500),
(1010, 'Andrea', 'Hart','15872167729', 'Andrea.Hart@email.com','123456','employee', '9024 Cactus Dr.',
'Boca Raton', 'FL', 'USA','2015-08-13', 'I am employee here.', '1989-07-16', 'female', 3500),
(1011, 'Melanie', 'Lawrence','14408696376', 'Melanie.Lawrence@email.com','123456','employee', '89 Whitemarsh Dr.',
'Lake Mary', 'FL', 'USA','2015-08-13', 'I am employee here.', '1989-07-16', 'female', 3500),
(1012, 'Max', 'Davidson','19226419180', 'Max.Davidson@email.com','123456','employee', '9827 West Indian Spring Street',
'New Bedford', 'MA', 'USA','2015-08-13', 'I am employee here.', '1989-07-16', 'female', 3500),
(1013, 'Brandon', 'Mackenzie','12399739247', 'Brandon.Mackenzie@email.com','123456','employee', '9020 Beach St.',
...
(1014, 2, 0, 2, curdate()),(1014, 3, 0, 1, curdate()),(1014, 4, 0, 2, curdate()),
(1015, 1, 0, 2, curdate()),(1015, 2, 0, 1, curdate()),(1015, 2, 0, 1, curdate()),
(1015, 1, 0, 1, curdate()),(1015, 2, 0, 2, curdate()),(1015, 3, 0, 1, curdate()),
(1014, 4, 0, 2, curdate()),(1014, 2, 0, 1, curdate()),(1014, 2, 0, 2, curdate()),
(1018, 13, 0, 3, curdate()),(1018, 7, 0, 2, curdate()),(1018, 10, 0, 2, curdate());
-- insert into order_item(orderId, itemId, discount, quantity, createdAt) values
