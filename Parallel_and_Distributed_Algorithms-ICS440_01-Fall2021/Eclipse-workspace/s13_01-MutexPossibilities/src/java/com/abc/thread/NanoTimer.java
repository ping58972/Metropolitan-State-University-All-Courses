...
public class NanoTimer {
    public static final double NS_PER_MILLISECOND = 1000000.0;
    public static final double NS_PER_SECOND = NS_PER_MILLISECOND * 1000.0;
    public static final double NS_PER_MINUTE = NS_PER_SECOND * 60.0;
    public static final double NS_PER_HOUR = NS_PER_MINUTE * 60.0;
    public static final double NS_PER_DAY = NS_PER_HOUR * 24.0;
