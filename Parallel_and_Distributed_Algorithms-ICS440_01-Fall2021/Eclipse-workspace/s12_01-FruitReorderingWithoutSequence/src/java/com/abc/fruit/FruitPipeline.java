...
public class FruitPipeline {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        PPBoundedFifo<FruitWork> processorInputFifo = new CircularArrayPPBoundedFifo<>(10, FruitWork.class);
        PPBoundedFifo<FruitWork> processorOutputFifo = new CircularArrayPPBoundedFifo<>(10, FruitWork.class);

        int workCount = 60;
        int processorCount = 10;

        FifoReorderer<FruitWork> reorderer = new FifoReorderer.Builder<FruitWork>()
            .setItemType(FruitWork.class)
            .setMaxBacklog(5)
            .setFrontEndInputFifo(needsProcessingFifo)
            .setFrontEndOutputFifo(processorInputFifo)
            .setBackEndInputFifo(processorOutputFifo)
            .setBackEndOutputFifo(processedFifo)
            .create();
        ...
        for (int i = 0; i < processors.length; i++) {
            processors[i] = new FruitProcessor(processorInputFifo, processorOutputFifo);
        }
        ...
        reorderer.frontEnd.stopRequest();
        reorderer.backEnd.stopRequest();
    ...
    private static class FruitWork {
        ...
        public String toString() {
            return String.format("seq=%d, name=%s", sequence, name);
        }
    }  // type FruitWork
